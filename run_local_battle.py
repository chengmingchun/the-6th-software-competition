...
def run_battle(seed: int = 42, player1_id: str = "1001", player2_id: str = "1002",
    ...
    strategy1 = BaselineStrategy(player_id=player1_id, config=config, logger=logger1)
    strategy2 = BaselineStrategy(player_id=player2_id, config=config, logger=logger2)
